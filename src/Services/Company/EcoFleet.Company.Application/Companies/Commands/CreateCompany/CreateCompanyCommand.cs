  ...
  //      private readonly IUnityOfWork _unityOfWork;
    //    private readonly IPasswordHasher _passwordHasher;
      //  private readonly IUserRepo _userRepo;
        ...
        public CreateCompanyCommandHandler(ICompanyRepo companyRepo
        //, IUnityOfWork unityOfWork, IPasswordHasher passwordHasher, IUserRepo userRepo
        )
        {
      ...
      //      _passwordHasher = passwordHasher;
       //     _userRepo = userRepo;
        ...
        public async Task<Guid> Handle(CreateCompanyCommand request, CancellationToken cancellationToken)
        {
            ...
            var company = Domain.Companies.Company.Create(request.Name, request.TaxNumber, request.AdminEmail, domain);
